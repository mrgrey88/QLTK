...
namespace BMS
{
    public partial class frmFile3DDienTu : _Forms
    {        
        #region Variables
        string _dPath ="";
        public int CatID=0;
        ...
        #region Constructor
        public frmFile3DDienTu()
        {
            InitializeComponent();
        }

        private void frmFile3DDienTu_Load(object sender, EventArgs e)
        {
            loadCombo(CatID);
            ...
            //grdData.DataSource = TextUtils.Select("File3D", new Expression("ID", 0));
        } 
        #endregion
